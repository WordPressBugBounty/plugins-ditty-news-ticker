...
= 3.1.71 [2026-09-23] =
* Security fix: sanitize custom display settings and block protected keys passed via shortcodes, blocks and AJAX

= 3.1.70 [2026-09-21] =
* Security fix: restrict layout tag wrapper elements to an allowlist of safe HTML elements
